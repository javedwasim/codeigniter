...
<?php echo form_open_multipart(); ?>
   <div>
    ...
    <div>
        ...
        <?php echo form_input('issue_number', set_value('issue_number', isset($issue->issue_number) ? $issue->issue_number : '')); ?>
    </div>
    <div>
        <?php echo form_label('Date Published','issue_date_publication'); ?>
        <?php echo form_input('issue_date_publication', set_value('issue_date_publication',isset($issue->issue_date_publication) ? $issue->issue_date_publication : '')); ?>
    </div>
    <div>
