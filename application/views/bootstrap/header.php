...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="/codeigniter/css/bootstrap-responsive.min.css">
        <link rel="stylesheet" href="/codeigniter/css/main.css">

        <script src="/codeigniter/js/vendor/modernizr-2.6.2.min.js"></script>
    </head>
    <body>
                        ...
                        <ul class="nav">
                          <?php
                            foreach ($menu_items as $item => $item_data) {
                              ...
                              echo '<a href="/codeigniter/index.php/magazine/' . $item . '" title="' . $item_data['desc'] . '">' . $item_data['label'] . '</a>';
                              echo '</li>';
                            }
                          ?>
                        </ul>
